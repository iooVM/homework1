...
'''
 TODO:
    1. разделить все функции на:
        1.1 получения данных ( файлы, БД, API, ssh и т.п.)
        1.2 функции обработки данных
        1.3 интерфейсы общения с пользователем ( console, GUI, WEB и т.п.)
    2. Добавить проверки корректности ввода 
     2.2 Имена  - все символы
     2.3 Телефон - все цифры и разделители 
     2.4 
